...
public class GenericJpaDAO <T extends Persistente, E extends Serializable> implements IGenericDAO <T,E> {
	...
	public GenericJpaDAO(Class<T> persistenteClass2, String persistenceUnitName) {
		this.persistenteClass = persistenteClass2;
